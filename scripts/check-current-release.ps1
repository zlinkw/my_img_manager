...
if ($manifest.version -ne "0.1.140") { throw "Release candidate version must be 0.1.140" }
...
foreach ($required in @("publishPreviewEntriesToSharedLibrary", "refreshLibrary", 'GLOBAL_LIBRARY_VIEW_VERSION = "40"', "paper-image-library-view")) {
