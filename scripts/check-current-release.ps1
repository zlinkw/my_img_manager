...
if ($manifest.version -ne "0.1.160") { throw "Release candidate version must be 0.1.160" }
...
foreach ($required in @("publishPreviewEntriesToSharedLibrary", "refreshLibrary", 'GLOBAL_LIBRARY_VIEW_VERSION = "50"', "paper-image-library-view", 'drawer: "canvas"')) {
