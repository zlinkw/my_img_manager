...
if ($manifest.version -ne "0.1.159") { throw "Release candidate version must be 0.1.159" }
...
foreach ($required in @("publishPreviewEntriesToSharedLibrary", "refreshLibrary", 'GLOBAL_LIBRARY_VIEW_VERSION = "49"', "paper-image-library-view", 'drawer: "canvas"')) {
