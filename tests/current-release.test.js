...
for (const text of [
  'data-paper-image-library-version="50"',
  "刷新图库",
  "导入分享包",
  "分享所选",
  "删除所选",
  ...
  'data-select-mode="brush"',
  'data-select-mode="erase"',
  'id="viewer-selection-size"',
  'id="viewer-selection-fill-holes"',
  'id="viewer-selection-raster-export"',
  'id="viewer-selection-export"',
  "已下载原图；图库保持打开",
...
assert.equal(manifest.version, "0.1.160", "release candidate increments the installed release");
