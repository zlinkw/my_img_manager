...
- UI-first backlog is largely exhausted; dense labels cover main surfaces, toast reuses one element, toolbar widths stay stable, prefs status includes live helper caps, and clip selection shows live size. Further UI work only for concrete clarity gaps.
