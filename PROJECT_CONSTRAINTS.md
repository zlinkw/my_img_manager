...
- UI-first backlog is largely exhausted; toolbar now locks quality/auto during clip, and HTML index cards stay dense. Further UI work only for concrete clarity gaps.
