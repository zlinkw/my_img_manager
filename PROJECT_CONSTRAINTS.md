...
- UI-first backlog is largely exhausted; toolbar locks quality/auto during clip, and menus/prefs/status use dense quality labels. Further UI work only for concrete clarity gaps.
