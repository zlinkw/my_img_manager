...
- Capture stores figure `image_category`, `color_family`, `layout_hint`, `aspect_ratio`, `slide_slot`, `dominant_hex`, `contrast_hex`, palette, `style_tags`, and `ppt_assist_token` for PPT search/color/layout/placement/drawing assist; toolbar/prefs expose Cat; indexes expose category/layout/slot filters, palette chips, Copy PPT/pal/pair.
