...
- UI-first backlog is largely exhausted; toolbar locks quality/auto during clip, menus/prefs use dense quality labels, and toast/skip feedback stays compact. Further UI work only for concrete clarity gaps.
