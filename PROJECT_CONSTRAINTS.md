...
- UI-first backlog is largely exhausted; toolbar locks quality/auto during clip; menus/prefs/diagnostics/toasts/HTML indexes stay dense. Further UI work only for concrete clarity gaps.
