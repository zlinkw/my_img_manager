...
- UI-first backlog is largely exhausted; dense labels cover main surfaces and toast updates reuse one element to reduce flicker. Further UI work only for concrete clarity gaps.
