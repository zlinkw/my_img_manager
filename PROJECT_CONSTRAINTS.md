...
- UI-first backlog is largely exhausted; dense labels now cover toolbar/menus/prefs/diagnostics/toasts/HTML indexes/auto-unavailable reasons. Further UI work only for concrete clarity gaps.
