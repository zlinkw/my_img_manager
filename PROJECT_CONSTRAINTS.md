...
- Prefs status and diagnostics already surface Q/dups/caps/auto max/auto-helper mins, helper page/doc/timeout, and custom/auto py mode; preview/original indexes share Open actions and densified headers/titles.
