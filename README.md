...
Saved figure metadata includes `image_category`, `color_family`, palette, `style_tags`, and `ppt_assist_token / layout_hint / aspect_ratio / slide_slot / dominant_hex / contrast_hex` for PPT search/color assist.
