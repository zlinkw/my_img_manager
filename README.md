...
- 查看器可用“矩形框选”快速铺底，再用“选区画笔”多次补选、“选区橡皮”精细擦除；笔径可设为 1–64 原图像素。选区蒙版随图像同步缩放、平移，放大后便于修边。“导出选区 SVG”以人工选区为精确裁剪轮廓，并描摹选中原图的颜色区域，全部输出为 SVG 路径。擦出的孔洞默认保持透明；只有勾选“填补内孔”才用周围主色补上封闭孔洞。原图与整图近似矢量导出仍可单独使用。
